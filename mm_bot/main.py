...
<<<<<<< HEAD
    ...
    if config_path.exists():
        ...
        wallet_config, connection_config, cache_config, market_config = load_secrets_from_env(
        ...
        wallet_config, connection_config, cache_config, market_config, bot_config = load_config_from_env()
    ...
    # Create bot
    bot = Bot(connection_config, cache_config, wallet_config, market_config, bot_config)
